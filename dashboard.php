		    ...
		    <div class="drop-men" >
		        <ul class=" nav_1">
					<li class="dropdown" style="padding:20px;">
		              <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret">Welcome &nbsp<?php echo $_SESSION['fullname']?><i class="caret"></i></span>
